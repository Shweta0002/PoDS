        ...
        for (String line : shows) {
          ...
          //showActors.put(show_id, ref2);
                ...
                ActorRef<BookingRegistry.Command> bookingRegistryActor =
                    context.spawn(BookingRegistry.create(router,sharding), "UserRegistry");
            ...
            for(int i = 0; i < 50; i++){
                ActorRef<WorkerActor.Command> worker = context.spawn(WorkerActor.create(sharding), "worker" + replica*50+i);
